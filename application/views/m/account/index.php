...
<section class="cash-text widthMax">
	...
	<div class="cash-option flex">
		<a href="<?php echo site_url('m/account/deposit'); ?>">充值</a>
		<a href="<?php echo site_url('m/account/withdraw'); ?>">提现</a>
	</div>
	<ul class="cash-ul">
		<li>
			<a href="<?php echo site_url('m/card/bankCard'); ?>" class="flex">
				<p class="flex-1">我的银行卡</p>
				<i class="cash-icon iconfont icon-youjiantou"></i>
			</a>
		</li>
		<li>
			<a href="<?php echo site_url('m/account/myBouns'); ?>" class="flex">
		...
		<li>
			<!-- <a href="<?php echo site_url('m/safetycenter/selectPaymentStrategy'); ?>" class="flex"> 支付密码-->
			<a href="<?php echo site_url('m/safetycenter/selectLoginStrategy'); ?>" class="flex">
